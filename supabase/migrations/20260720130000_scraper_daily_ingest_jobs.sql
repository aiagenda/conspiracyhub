-- Daily ingest jobs (Admin → Automation → Ingest & intel) at 09:00 UTC via /api/scheduler/tick
...
values
  ...
  (
    'uap_nuforc',
    'NUFORC sightings scrape',
    'uap_scraper',
    '0 9 * * *',
    false,
    '{"mode":"nuforc_only","max_new":70}'::jsonb
  ),
