...
const NODE_COLORS: Record<string, { bg: string; border: string; text: string; glow: string }> = {
  ...
  government: { bg: "#0f0f1a", border: "#8aa6ff", text: "#aabfff", glow: "rgba(138,166,255,0.25)" },
  country: { bg: "#0a0f1a", border: "#5577cc", text: "#7799dd", glow: "rgba(85,119,204,0.22)" },
