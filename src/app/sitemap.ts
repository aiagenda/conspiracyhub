...
const STATIC_ROUTES: MetadataRoute.Sitemap = [
  ...
  { url: `${SITE_URL}/seismic`, lastModified: new Date(), changeFrequency: "hourly", priority: 0.8 },
  ...
  { url: `${SITE_URL}/toolkit`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.45 },
