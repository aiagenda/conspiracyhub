...
export const metadata: Metadata = {
  ...
  description:
    "How to use The Theorist: FEED, highest impact signal, Insider Radar, ANALYSIS reports (/blog), Investigation Board, federal spending, Oracle AI, UAP files, outbreaks, seismic monitor, account, and search.",
  openGraph: {
