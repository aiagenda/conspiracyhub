...
/** Five ingest jobs that must run daily at 09:00 UTC via /api/scheduler/tick. */
...
/** Idempotent — ensures five daily ingest jobs exist, enabled, and scheduled at 09:00 UTC. */
